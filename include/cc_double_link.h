 ...
 * doubly-linked list.
 */
struct dlist_element_{
  void *data; /**< Holds the element's data, which can be a pointer to any kind of data. */
  struct dlist_element_ *prev; /**< Contains the link to the previous element in the list. */
  struct dlist_element_ *next; /**< Contains the link to the next element in the list. */
};
typedef struct dlist_element_ dlist_element;
...
uint32_t delete_dlist_element( dlist_element *element );
uint32_t delete_dlist( dlist_element *element );
