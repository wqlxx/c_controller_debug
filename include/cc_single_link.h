...
uint32_t create_list( list_element **list );
uint32_t insert_in_front( list_element **head, void *data );
uint32_t insert_before( list_element **head, const void *sibling, void *data );
uint32_t append_to_tail( list_element **head, void *data );
...
void *find_list_custom( list_element *head, uint32_t (*function)( void *data, void *user_data ), void *user_data );
uint32_t delete_element( list_element **head, const void *data );
uint32_t delete_list( list_element *head );
