...
buffer *cc_create_hello(  uint32_t  transaction_id);
buffer *cc_create_error(  uint32_t transaction_id,  uint16_t type,
                       uint16_t code,  buffer *data );
buffer *cc_create_echo_request(  uint32_t transaction_id,  buffer *body );
buffer *cc_create_echo_reply(  uint32_t transaction_id,  buffer *body );
buffer *cc_create_vendor(  uint32_t transaction_id,  uint32_t vendor,
                        buffer *body );
buffer *cc_create_features_request(  uint32_t transaction_id );
